...
abstract class $InvoiceItemCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String desc, String note, int qty, double price});
}
...
class _$InvoiceItemImpl implements _InvoiceItem {
  ...
  @override
  String toString() {
    return 'InvoiceItem(id: $id, desc: $desc, note: $note, qty: $qty, price: $price)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, desc, note, qty, price);
...
abstract class _InvoiceItem implements InvoiceItem {
  const factory _InvoiceItem(
      ...
      final String note,
      final int qty,
      final double price}) = _$InvoiceItemImpl;
